...
// @brief : A file that defines file system structure.
//          The original code came from professor's code.
//          Modified a bit of definitions for ease of use.
//
...
#define INODE_MODE_AC_USER_R	0x400
#define INODE_MODE_AC_USER_W	0x200
#define INODE_MODE_AC_USER_X	0x100
#define INODE_MODE_AC_OTHER_R	0x004
#define INODE_MODE_AC_OTHER_W	0x002
#define INODE_MODE_AC_OTHER_X	0x001
#define INODE_MODE_AC_GRP_R		0x040
#define INODE_MODE_AC_GRP_W		0x020
#define INODE_MODE_AC_GRP_X		0x010


#define INODE_MODE_REG_FILE		0x10000
#define INODE_MODE_DIR_FILE		0x20000
#define INODE_MODE_DEV_FILE		0x40000
#define INODE_MODE_EMPTY_FILE   0x01000
...
struct inode {
    ...
    unsigned int date;
    unsigned int size;
    int indirect_inode; 	// N.B. -1 for NULL
